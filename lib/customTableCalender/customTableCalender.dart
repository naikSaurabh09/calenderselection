...
import 'package:calenderselection/customTableCalender/customCalenderHeader.dart';
...
import 'package:calenderselection/customTableCalender/customCellContent.dart';
...
import 'package:calenderselection/customTableCalender/customSimpleGestureDetector.dart';
import 'package:calenderselection/customTableCalender/customTableCalenderBase.dart';
...
class customTableCalendar<T> extends StatefulWidget {
  ...
  final customSimpleSwipeConfig simpleSwipeConfig;
  ...
  final customDaysOfWeekStyle daysOfWeekStyle;
  ...
  final customCalendarBuilders<T> calendarBuilders;
  ...
  customTableCalendar({
    ...
    this.headerStyle = const customHeaderStyle(),
    this.daysOfWeekStyle = const customDaysOfWeekStyle(),
    this.calendarStyle = const customCalendarStyle(),
    this.calendarBuilders = const customCalendarBuilders(),
  ...
  @override
  _customTableCalendarState<T> createState() => _customTableCalendarState<T>();
}

class _customTableCalendarState<T> extends State<customTableCalendar<T>> {
  ...
  Widget _buildCell(DateTime day, DateTime focusedDay) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget content = customCellContent(

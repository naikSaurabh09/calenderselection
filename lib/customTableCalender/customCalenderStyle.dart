...
class customCalendarStyle {
  ...
  final customPositionedOffset markersOffset;
  ...
  const customCalendarStyle({
    ...
    this.markersOffset = const customPositionedOffset(),
...
class customPositionedOffset {
  ...
  const customPositionedOffset({this.top, this.bottom, this.start, this.end});
}

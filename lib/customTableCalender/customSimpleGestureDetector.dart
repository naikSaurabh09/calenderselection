...
class customSimpleGestureDetector extends StatefulWidget {
  /// Widget to be augmented with gesture detection.
  final Widget child;

  /// Configuration for swipe gesture.
  final customSimpleSwipeConfig swipeConfig;
  ...
  const customSimpleGestureDetector({
    Key? key,
    required this.child,
    this.swipeConfig = const customSimpleSwipeConfig(),
  ...
  @override
  _customSimpleGestureDetectorState createState() => _customSimpleGestureDetectorState();
}

class _customSimpleGestureDetectorState extends State<customSimpleGestureDetector> {

...
import 'package:calenderselection/customTableCalender/customCalenderCore.dart';
...
class customTableCalendarBase extends StatefulWidget {
  ...
  @override
  _customTableCalendarBaseState createState() => _customTableCalendarBaseState();
}

class _customTableCalendarBaseState extends State<customTableCalendarBase> {
  ...
  @override
  void didUpdateWidget(customTableCalendarBase oldWidget) {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        return customSimpleGestureDetector(
